...
export const ui = {
  nb: {
    ...
    'login.subtitle': 'Få tilgang til ditt studio og dine kjøp.',
    'login.email.label': 'Epost',
    'login.email.placeholder': 'din@epost.no',
    'login.magicLink.cta': 'Send meg lenken',
    'login.divider.or': 'eller',
    'login.google': 'Fortsett med Google',
    'login.success.heading': 'Sjekk eposten din',
    'login.success.body': 'Vi har sendt deg en lenke. Trykk på den for å logge inn.',
    'login.error.generic': 'Noe gikk galt. Prøv igjen.',
    ...
    'studio.nav.needles': 'Pinner',
    'studio.nav.library': 'Bibliotek',
    'studio.nav.tools': 'Verktøy',
    'studio.nav.learn': 'Lær',
    'studio.nav.purchases': 'Kjøp',
    'studio.nav.profile': 'Profil',
    'studio.nav.signout': 'Logg ut',
    'studio.empty.projects': 'Ingen prosjekter ennå. Start med en oppskrift.',
    'studio.empty.stash': 'Garnlageret ditt er tomt. Legg til ditt første garn.',
    'studio.empty.tools': 'Verktøy kommer i neste runde.',
  ...
  en: {
    ...
    'login.title': 'Log in',
    'login.subtitle': 'Access your studio and your purchases.',
    'login.email.label': 'Email',
    'login.email.placeholder': 'you@email.com',
    'login.magicLink.cta': 'Send me the link',
    'login.divider.or': 'or',
    'login.google': 'Continue with Google',
    'login.success.heading': 'Check your email',
    'login.success.body': "We've sent you a sign-in link. Click it to continue.",
    ...
    'studio.nav.needles': 'Needles',
    'studio.nav.library': 'Library',
    'studio.nav.tools': 'Tools',
    'studio.nav.learn': 'Learn',
    'studio.nav.purchases': 'Purchases',
    'studio.nav.profile': 'Profile',
    'studio.nav.signout': 'Sign out',
    'studio.empty.projects': 'No projects yet. Start with a pattern.',
    'studio.empty.stash': 'Your yarn stash is empty. Add your first yarn.',
    'studio.empty.tools': 'Tools coming in the next batch.',
